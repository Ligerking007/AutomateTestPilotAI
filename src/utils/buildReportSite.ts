...
<html lang="en">
  <head>
    ...
    <title>Automate Test Pilot AI Reports</title>
  ...
  <body>
    <main class="page">
      <header class="topbar" aria-label="Site header">
        ...
        <nav class="site-nav" aria-label="Main navigation">
          ...
          <div class="nav-controls" aria-label="Display preferences">
            ...
            <button class="nav-button icon-button" type="button" data-theme-toggle aria-label="Current theme: light" title="Light theme">☀️</button>
          </div>
        </nav>
      </header>
      ...
      <section class="section" aria-label="Automation pipeline">
        ...
        <div class="pipeline">
          ...
          <div class="step">
            ...
            <strong data-i18n="stepCases">AI or Manual Test Cases</strong>
      ...
      <footer class="meta">
        <span data-i18n="footerGenerated">Report site generated by Automate Test Pilot AI</span>
    ...
    <script>
      const messages = {
        en: {
          ...
          stepCases: 'AI or Manual Test Cases',
          ...
          footerGenerated: 'Report site generated by Automate Test Pilot AI'
        },
        th: {
      ...
      function applyTheme(theme) {
        ...
        themeButton.textContent = active === 'dark' ? '🌙' : '☀️';
        themeButton.setAttribute('aria-label', active === 'dark' ? 'Current theme: dark' : 'Current theme: light');
        themeButton.setAttribute('title', active === 'dark' ? 'Dark theme' : 'Light theme');
      }
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Playwright Report | Automate Test Pilot AI</title>
    <link rel="icon" href="./favicon.svg" type="image/svg+xml">
    <style>
      :root {
        color-scheme: light;
    ...
    <div class="shell">
      <header class="site-header">
        <div class="header-inner">
          <a class="brand" href="./index.html" aria-label="Automate Test Pilot AI home">
